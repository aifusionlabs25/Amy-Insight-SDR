                ...
                <span className={styles.deviceButtonIcon}>
                    {isCamMuted ? (
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" role="img" aria-label="Camera Muted">
                            ...
                            <defs><clipPath id="clip0_7082_14220"><rect width="24" height="24" fill="white" /></clipPath></defs>
                        </svg>
                    ) : (
